  ...
  return (
    <div className="flex flex-col pt-20">
      <img
        ...
        alt="Alt"
      />
      <h1 className="text-white leading-[180px] text-[150px] max-xl:text-6xl ESRG-TRIAL-font font-normal mt-[15px] mb-[30px] max-xl:mb-[10px] break-words">
        What is Harmony?
      </h1>
      <p className="text-white text-[40px] max-xl:text-[20px] sfpro-font font-normal mt-[35px] mb-[134px]">
